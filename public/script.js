document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const label = input.getAttribute('data-label') || 
                              (input.closest('.form-group')?.querySelector('label')?.textContent || name);
                showError(input, (label ? label + ' ' : '') + 'هذا الحقل مطلوب');
                return false;
            }
            ...
            if (value && input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                showError(input, 'يجب أن يحتوي على ' + input.getAttribute('minlength') + ' أحرف على الأقل');
                return false;
            }
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(function() {
                        ...
                        successMsg.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; text-align: center; font-weight: bold;';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.closest('input') || input.closest('textarea') || input.closest('select'))) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd0fd95d0-fa69-47c8-abd2-e5414ed056c9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd0fd95d0-fa69-47c8-abd2-e5414ed056c9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd0fd95d0-fa69-47c8-abd2-e5414ed056c9';
